...
import { ArrowRight, SquareTerminal, Zap, CheckIcon, ArrowRightIcon, VideoIcon,Code2Icon,UsersIcon } from "lucide-react"
function Homepage() {
    return (
          ...
          <SignedIn>
            ...
            <nav className='base-100/80 backdrop-blur-md border-b-primary/20 sticky top-0 z-50 shadow-lg'>
                <div className='max-w-7xl mx-auto p-4 flex items-center justify-between'>
                    ...
                    <SignInButton mode='modal'>
                        <button className='group flex items-center gap-2 bg-linear-to-r from-primary to-secondary p-2 rounded-xl shadow-lg  hover:transition-all hover:scale-105 duration-200'>
            ...
            <div className='max-w-7xl mx-auto px-4 py-20'>
                <div className='grid lg:grid-cols-2 gap-12 items-center '>
                    ...
                    <div className='space-y-12'>
                        <span className='badge badge-primary badge-xl '>
                            <Zap />
